...
try {
  ...
  console.log("ejercicio1-2:", Math.round(circle.area()) === 78 ? "ok" : "falló", circle.area());
} catch (e) {
...
try {
  ...
  console.log("ejercicio4:", user.name === "Ana" && user.id === 1 ? "ok" : "falló", user);
} catch (e) {
...
try {
  ...
  console.log("ejercicio6:", typeof instance.log === "function" ? "ok" : "falló");
} catch (e) {
...
try {
  new Counter();
  new Counter();
  console.log("ejercicio7:", Counter.getCount() === 2 ? "ok" : "falló", Counter.getCount());
} catch (e) {
